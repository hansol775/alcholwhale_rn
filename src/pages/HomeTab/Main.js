...
export default class Main extends Component {
    ...
    render() {
        return (
            <Container>
                <Content>
                    <View style={{ flex: 0.1, marginLeft: 20, marginVertical: 10 }}>
                        <Image source={require('../../images/logo.png')} style={{ width: 108, height: 36 }} resizeMode='contain' />
                    </View>
                    <View style={{ flexDirection: 'row', marginBottom: 10 }}>
                        <View style={{flex:1, flexDirection:'row', justifyContent:'space-between', alignItems:'center',  marginHorizontal:20}}>
                            <TextInput
                                ...
                                style={{flex:1, color:'#202020', fontSize:16}}    
                            />
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', borderTopColor: '#BB996A', borderTopWidth: 4, borderBottomColor: '#BB996A', borderBottomWidth: 1 }}>
                    ...
                    <View style={{ padding: 20 }}>
                        <Text style={{ color: '#000', fontSize: 16, fontWeight: '400' }}><Text style={{ color: '#BB996A', fontSize: 16, fontWeight: 'bold' }}>여선주</Text> 님을 위한 술고래의 추천</Text>
                    </View>
                    <View style={{ flex: 1 }}>
                        <TouchableOpacity
